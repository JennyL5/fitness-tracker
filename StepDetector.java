//create a step detector class which will accept updates from accelerometer sensor 
//and deploys the filter to detect if a step has been covered by the user
